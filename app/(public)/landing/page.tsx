  ...
  return (
    <section>
      <div className="text-center mb-10">
        ...
        <p className="mt-3 text-neutral-500 max-w-lg mx-auto">
          A calm, focused dashboard that surfaces what matters — no noise, no clutter.
        </p>
      </div>

      {/* Mock dashboard — mirrors real PortfolioOverview structure */}
      <div className="bg-[#f6f7f8] rounded-2xl border border-neutral-200 overflow-hidden shadow-lg">
        {/* Fake header bar */}
        ...
        <div className="p-4 sm:p-6">
          {/* ── Hero card (portfolio value + insights) ── */}
          ...
          {/* ── AI Analysis Result (the "wow" section) ── */}
