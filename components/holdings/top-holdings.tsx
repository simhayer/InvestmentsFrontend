    ...
    >
      <CardHeader className="pb-2 sm:pb-3">
        <div className="flex flex-wrap items-center justify-between gap-3">
          ...
          >
            Holdings overview <ArrowRight className="h-3.5 w-3.5" />
          </Link>
        </div>
      </CardHeader>
        ...
        {loading ? (
          ...
          <div className="overflow-hidden rounded-2xl border border-neutral-200/70 bg-white">
            <div className="hidden sm:block">
              <div className="grid grid-cols-[minmax(0,1fr)_minmax(0,120px)_minmax(0,140px)] gap-2 bg-neutral-50 px-4 py-2 text-[11px] font-semibold uppercase tracking-[0.12em] text-neutral-500">
                <span>Asset</span>
                  ...
                  {visibleHoldings.map((holding, idx) => {
                    ...
                    return (
                      <button
                        ...
                        className="grid w-full grid-cols-[minmax(0,1fr)_minmax(0,120px)_minmax(0,140px)] items-center gap-2 px-4 py-2.5 text-left transition hover:bg-neutral-50/80"
                      >
                        <div className="min-w-0 text-sm font-semibold text-neutral-900">
                          {holding.symbol}
                        </div>
