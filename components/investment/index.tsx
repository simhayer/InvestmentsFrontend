...
export default function InvestmentOverview({ symbol }: { symbol: string }) {
  ...
  return (
    <Page className="space-y-7 sm:space-y-8">
      {/* Asset hero */}
      <section className="rounded-3xl border border-neutral-800/40 bg-gradient-to-br from-neutral-900 via-neutral-800 to-neutral-900 px-5 py-6 text-white shadow-[0_24px_70px_-42px_rgba(15,23,42,0.55)] sm:px-7 sm:py-7 lg:px-9 lg:py-8">
        <div className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
          ...
          <div className="flex w-full flex-col gap-3 lg:w-auto lg:items-end">
            <div className="flex flex-wrap items-center justify-between gap-3 lg:justify-end">
              <div className="min-w-[210px] rounded-2xl bg-white/10 px-5 py-4 text-right shadow-inner ring-1 ring-white/10">
                {loadingQ ? (
              ...
              <Button
                ...
                onClick={fetch}
                disabled={loading}
                className="rounded-xl bg-white text-neutral-900 shadow-sm hover:bg-white/90"
              >
      ...
      <section className="space-y-3">
        <Card className="overflow-hidden rounded-3xl border border-neutral-200/70 bg-white shadow-[0_22px_60px_-38px_rgba(15,23,42,0.35)]">
          <div className="flex flex-wrap items-start justify-between gap-3 px-4 pt-4 sm:px-6">
            ...
            <div className="flex flex-wrap items-center gap-3">
              {dayBadge ? (
                <div className="hidden md:block">{dayBadge}</div>
              ) : null}
        ...
        <Card className="rounded-2xl border border-neutral-200/80 bg-white shadow-sm">
          <div className="space-y-3 px-4 py-4 sm:px-5">
            <div className="flex flex-wrap items-center justify-between text-xs text-neutral-600">
              ...
              <span className="text-neutral-500">Positioned vs highs/lows</span>
            </div>
      ...
      {analysis ? <StockAnalysisCard stock={JSON.parse(analysis)} /> : null}

      {/* Fundamentals */}
      <section>
        <Card className="rounded-3xl border border-neutral-200/70 bg-white p-5 shadow-[0_22px_60px_-38px_rgba(15,23,42,0.35)] sm:p-6">
        ...
        <Card className="overflow-hidden rounded-3xl border border-neutral-200/70 bg-white shadow-[0_22px_60px_-38px_rgba(15,23,42,0.35)]">
          <div className="flex flex-col gap-1 px-5 pt-5 sm:flex-row sm:items-center sm:justify-between">
            <div>
              ...
              <p className="text-sm text-neutral-600">
                Switch between fundamentals, earnings, analysts, profile, and
                news
              </p>
            </div>
          </div>
